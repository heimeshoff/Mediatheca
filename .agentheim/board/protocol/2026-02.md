# Protocol archive — 2026-02

Entries rolled verbatim out of the live `.agentheim/knowledge/protocol.md` once 2026-02 was no longer the current month and the live file exceeded its line cap (ADR-0039, agentic-workflow-r2c7m). Newest-on-top order is preserved. See `../protocol.md` for the live log.
